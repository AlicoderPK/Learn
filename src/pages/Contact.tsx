              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="building-permits">Building Permits & NOC</option>
                    <option value="electrical-design">Electrical Design</option>
                    <option value="plumbing-design">Plumbing Design</option>
                  </select>
                </div>
            ...
            >
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8">
                  We're here to help bring your vision to life. Contact us through any of these channels 
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">+92-42-3571-1234</p>
